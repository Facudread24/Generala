...
int combinacionesG(int v[], int tam, int lanza) {
    ...
    esca = creciente(v, tam);
        ...
        if (gene == 4 && lanza == 1 || (v[1] != v[0] && gene == 4 && lanza==1)) 
        {
        ...
        else if (gene == 4 || (v[1] != v[0] && gene == 4)) 
        {
            gotoxy(55, 12);
            cout << "POKER 40 PUNTOS";
            return 40;
        }
        if (gene == 3 && full==2 && lanza == 1 || (gene == 2 && full==3 && lanza == 1))
        {
            gotoxy(55, 12);
            cout << "FULL SERVIDO 30 + 5 PUNTOS EXTRAS";
            return 35;
        }
        else if ((gene == 3 && full == 2 )|| (gene == 2 && full == 3 ))
        {
            gotoxy(55, 12);
            cout << "FULL 30 PUNTOS";
            return 30;
